...
<div class="">
    ...
    <p class="mb-4">
        <a href="#hero" class="text-green-100">Destacados</a>
    </p>
    <p class="mb-4">
        <a href="#gallery" class="text-green-100">Galería</a>
    </p>
    <p class="mb-4">
        <a href="#testimonials" class="text-green-100">Experiencias</a>
    </p>
    <p>
        <a href="#contacs" class="text-green-100">Contacto</a>
    </p>
</div>
<!-- Contact section -->
<div>
