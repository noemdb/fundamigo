<ul class="ml-2 list-style-none me-auto flex flex-col ps-0 lg:flex-row" data-twe-navbar-nav-ref>
    <li class="mb-4 lg:mb-0 lg:pe-2 flex justify-end" data-twe-nav-item-ref>
        <!-- Dashboard link -->
        <a class="text-white/60 transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none lg:px-2"
    ...
    <li class="mb-4 lg:mb-0 lg:pe-2 flex justify-end" data-twe-nav-item-ref>
        <x-dropdown>
            <x-slot name="trigger">
                <span class="text-white/60 transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none lg:px-2">
                    Participa
                </span>
            </x-slot>         
