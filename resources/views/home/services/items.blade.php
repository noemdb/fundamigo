...
<div class="my-2 mx-auto md:px-6">
    ...
    <section class="mb-2">
        ...
        <div class="background-radial-gradient text-center text-white lg:h-[250px] h-[250px] lg:pt-[10px] pt-[10px] border-y-2">
            <h2 class="mb-12 text-center text-3xl font-bold">Membresias</h2>
        </div>
        ...
        <div class="grid px-6 md:px-12 lg:grid-cols-3 xl:px-32" style="margin-top: -200px">
                        ...
                        <ol class="list-inside">
                            <li class="mb-4 flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor" class="mr-3 h-5 w-5 text-primary">
            ...
            <div class="py-12">
                <div
                    class="block h-full rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] lg:rounded-tl-none lg:rounded-bl-none">
                    <div
                        class="border-b-2 border-neutral-100 border-opacity-100 p-6 text-center">
                        <p class="mb-4 text-sm uppercase">
                            <strong>Anual</strong>
