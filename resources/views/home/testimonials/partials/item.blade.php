<div class="container mx-auto xl:px-2">
    ...
    <div class="grid items-center lg:grid-cols-2">
        <div class="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
            <div
                class="relative z-[1] block rounded-lg bg-[hsla(0,0%,100%,0.55)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[25px] md:px-12 lg:-mr-14">
        ...
        <div class="md:mb-12 lg:mb-0">
            <img src="https://mdbcdn.b-cdn.net/img/new/ecommerce/vertical/080.jpg"
                class="lg:rotate-[6deg] w-full rounded-lg shadow-lg" alt="image" />
        </div>
    </div>
