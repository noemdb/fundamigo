        ...
        <div class="w-100 mx-auto text-neutral-800 sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
            <div class="grid items-center gap-12 lg:grid-cols-2">
                ...
                <div class="relative mb-12 lg:mb-0">
                    ...
                    <div
                        class="relative bg-[hsla(139,18%,17%,1)] backdrop-blur-[25px] backdrop-saturate-[200%] block rounded-lg px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0.9)] dark:shadow-black/20 md:px-12">
                        <form>
                            ...
                            <div class="text-center">
                                <p class="mb-6 text-neutral-500 dark:text-neutral-50">
                                    Comience con:
                                </p>
                            </div>
