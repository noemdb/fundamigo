<div id="carouselExampleGallery" class="relative" data-te-carousel-init data-te-ride="carousel">
    <div class="absolute bottom-0 left-0 right-0 z-[2] mx-[15%] mb-4 flex list-none justify-center p-0"
        ...
        <button type="button" data-te-target="#carouselExampleGallery" data-te-slide-to="0" data-te-carousel-active
            class="mx-[3px] box-content h-[3px] w-[30px] flex-initial cursor-pointer border-0 border-y-[10px] border-solid border-transparent bg-white bg-clip-padding p-0 -indent-[999px] opacity-50 transition-opacity duration-[200ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none"
    ...
    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[200ms] ease-in-out motion-reduce:transition-none"
            ...
            <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%">
                <img data-te-lazy-src="{{asset('image/gallery/2.jpg')}}" data-te-lazy-load-init class="block w-full border rounded shadow" />
            </div>
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                <p>
        ...
        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[200ms] ease-in-out motion-reduce:transition-none"
            data-te-carousel-item style="backface-visibility: hidden">
            <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%">
                <img data-te-lazy-src="{{asset('image/gallery/3.jpg')}}" data-te-lazy-load-init class="block w-full border rounded shadow" />
            </div>
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
        ...
        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[200ms] ease-in-out motion-reduce:transition-none"
            data-te-carousel-item style="backface-visibility: hidden">
            <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%">
                <img data-te-lazy-src="{{asset('image/gallery/4.jpg')}}" data-te-lazy-load-init class="block w-full border rounded shadow" />
            </div>
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                {{-- <h5 class="text-xl">Third slide label</h5> --}}
                <p>
        ...
        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[200ms] ease-in-out motion-reduce:transition-none"
            data-te-carousel-item style="backface-visibility: hidden">
            <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%">
                <img data-te-lazy-src="{{asset('image/gallery/5.jpg')}}" data-te-lazy-load-init class="block w-full border rounded shadow" />
            </div>
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                {{-- <h5 class="text-xl">Third slide label</h5> --}}
                <p>
        ...
        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[200ms] ease-in-out motion-reduce:transition-none"
            data-te-carousel-item style="backface-visibility: hidden">
            <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%">
                <img data-te-lazy-src="{{asset('image/gallery/6.jpg')}}" data-te-lazy-load-init class="block w-full border rounded shadow" />
            </div>
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                {{-- <h5 class="text-xl">Third slide label</h5> --}}
                <p>
        ...
        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[200ms] ease-in-out motion-reduce:transition-none"
            data-te-carousel-item style="backface-visibility: hidden">
            <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%">
                <img data-te-lazy-src="{{asset('image/gallery/7.jpg')}}" data-te-lazy-load-init class="block w-full border rounded shadow" />
            </div>
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                {{-- <h5 class="text-xl">Third slide label</h5> --}}
                <p>
        ...
        <div class="relative float-left -mr-[100%] hidden w-full transition-transform duration-[200ms] ease-in-out motion-reduce:transition-none"
            data-te-carousel-item style="backface-visibility: hidden">
            <div class="relative overflow-hidden bg-cover bg-no-repeat" style="background-position: 50%">
                <img data-te-lazy-src="{{asset('image/gallery/8.jpg')}}" data-te-lazy-load-init class="block w-full border rounded shadow" />
            </div>
            <div class="absolute inset-x-[15%] bottom-5 hidden py-5 text-center text-white md:block">
                {{-- <h5 class="text-xl">Third slide label</h5> --}}
                <p>
