        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="w-full shrink-0 grow-0 basis-auto md:px-6 lg:w-7/12">
                <div class="mb-12 flex">
                    ...
                    <div class="ml-4 grow">
                        <p class="mb-1 font-bold">Enfoque integral en el desarrollo estudiantil</p>
                        <p class="text-neutral-500 dark:text-neutral-300">
                            La Fundación <strong>FUNDAMIGO</strong> reconoce la importancia de un enfoque integral en el desarrollo de los estudiantes. Además de brindar apoyo académico, la organización también se preocupa por su bienestar emocional, habilidades sociales y desarrollo personal. Mediante programas de mentoría, actividades extracurriculares y talleres especializados, <strong>FUNDAMIGO</strong>fomenta un crecimiento integral en los estudiantes.
                        </p>
                    </div>
                </div>
